<%@ Page Title="" Language="C#" MasterPageFile="~/Mater.Master" AutoEventWireup="true" CodeBehind="Add_Buyer.aspx.cs" Inherits="DilrukInventory.Add_Buyer" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="breadcrumb" runat="server">
    <ul class="breadcrumb">
		<li>
			<i class="ace-icon fa fa-user-plus home-icon"></i>
			<a href="#">Add Buyer</a>
		</li>
	</ul>
</asp:Content>
