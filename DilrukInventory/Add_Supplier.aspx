<%@ Page Title="" Language="C#" MasterPageFile="~/Mater.Master" AutoEventWireup="true" CodeBehind="Add_Supplier.aspx.cs" Inherits="DilrukInventory.test" %>
<%--title--%>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Add Supplier
</asp:Content>
		...
		<div class="col-xs-12">
            ...
            <div class="clearfix form-actions">
				<div class="col-md-offset-4 col-md-8">
					<button class="btn btn-info" type="button" runat="server" onserverclick="Submit">
