<%@ Page Title="" Language="C#" MasterPageFile="~/Mater.Master" AutoEventWireup="true" CodeBehind="Update_Buyer.aspx.cs" Inherits="DilrukInventory.Update_Buyer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Update Buyer
</asp:Content>
		...
		<div class="col-xs-12">
            ...
            <div class="clearfix form-actions">
				<div class="col-md-offset-4 col-md-8">
                    <asp:Button ID="Button1" class="btn btn-info" runat="server" Text="Save" OnClick="Button1_Click" />
